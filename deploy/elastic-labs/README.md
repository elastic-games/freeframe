...
3. For the current dual-dashboard Elastic deployment, follow `NATIVE_REVIEWS.md`.
   Studio handles member authentication. The review domain serves original
   FreeFrame; the portal serves the native workspace. `STUDIO_SSO.md` describes the earlier embedded
...
account. Keep the original FreeFrame web proxy in the final HTTPS review-domain
